...
public class OnUploadHelper implements OnUploadTaskCallback {
    
    private Context mContext;
    private OnUploadTaskCallback callback;
     ...
     */
    public OnUploadHelper(Context context, OnUploadTaskCallback callback) {
     ...
     */
    public OnUploadHelper(Context context, OnUploadTaskCallback callback, View v) {
        this.v = v;
        v.setEnabled(false);
        this.mContext = context;
        this.callback = callback;
